...
```{r}
library(readxl)
dt <- read_xlsx("C:\\Users\\Abit\\Documents\\KULIAH SMT 4\\ANREG\\DATA PRAKTIKUM ANREG.xlsx")
dt
```
...
$$E[\hat{Y}] = \hat{Y} =47.94 + 0.0008485 X$$
...
Oleh karena simpangan baku merupakan akar kuadrat dari ragam, maka nilai dugaan galat baku model yang kita bentuk adalah $S_e = \sqrt{408639.2} \approx 639.249$
...
Sebelumnya, melalui fungsi `lm` dan perhitungan manual yang sudah dibahas pada pertemuan sebelumnya, kita sudah mendapatkan nilai dugaan parameter β0 dan β1 sebesar 47.94 dan 0.0008485. Kedua nilai dugaan parameter tersebut dapat kita definisikan sebagai berikut.
...
Sehigga dapat disimpulkan bahwa pada taraf signifikansi 5%, selang kepercayaan untuk parameter $β_0$ adalah [ -603.4932 ,  699.3781  dan untuk parameter $β_1$ adalah [0.0008235258 ,  0.0008734934 ]
...
Berdasarkan output sintaks di atas, diketahui bahwa dugaan rataan nilai $Y$ ketika nilai x=10 adalah 47.95093. Selain itu, diindikasikan juga bahwa dalam taraf kepercayaan 95%, diyakini bahwa nilai dugaan rataan $Y$ ketika nilai x=10 berada dalam selang -234.1597 hingga 330.0616.
...
Berdasarkan output sintaks di atas, diketahui bahwa dugaan nilai individu Y ketika nilai x=10 adalah 47.95093. Selain itu, diindikasikan juga bahwa dalam taraf kepercayaan 95%, diyakini bahwa nilai amatan individu Y ketika nilai x=10 berada dalam selang -1289.55 hingga  1385.452.